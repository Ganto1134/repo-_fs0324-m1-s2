...
for(let e = 0; e < starWarsCharacters.length; e++){
  ...
  switch (starWarsCharacters[e].eye_color) {
    case "blue": eyeColor.blue.push(starWarsCharacters[e]);
    break;
    case "yellow": eyeColor.yellow.push(starWarsCharacters[e]);
    break;
    case "brown": eyeColor.brown.push(starWarsCharacters[e]);
    break;
...
for (var i = 0; i < starWarsCharacters.length; i++) {
    ...
    updatedCharacters.push(starWarsCharacters[i]);
}
...
for (var i = 0; i < femaleCharacters.length; i++) {
  var index = charactersNames.indexOf(femaleCharacters[i].name);
  if (index !== -1) {
